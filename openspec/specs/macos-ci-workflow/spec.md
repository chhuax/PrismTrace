# macos-ci-workflow Specification

## Purpose
定义 PrismTrace 仓库在 GitHub 上执行首版 macOS 持续集成校验的能力边界，确保当前 Rust workspace 的格式、静态检查、测试与 host discovery smoke test 可以通过统一的自动化入口被稳定验证。
